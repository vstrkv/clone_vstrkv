...
public class HelloWorld {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("User " + (user1 == userClone));
        System.out.println("Baby " + (user1.baby == userClone.baby));
        ...
        System.out.println("User " + (user2 == userCloneDeep));
        System.out.println("Baby " + (user2.baby == userCloneDeep.baby));
        System.out.println("____изменение пораметров");
        user2.id = 3;
